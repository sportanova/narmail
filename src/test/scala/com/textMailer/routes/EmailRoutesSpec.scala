...
class EmailRoutesSpec extends MutableScalatraSpec {
  ...
  "get /emails" should {
    "get emails for a topic" in {
      ...
      val email1 = Email("someEmId1", "someId", threadId, recipientsHash, "time", "subject1", "cc", "bcc", "emailBody")
      val email2 = Email("someEmId2", "someId", threadId, recipientsHash, "time1", "subject1", "cc", "bcc", "emailBody")
      ...
      get(s"/${user.id}/${threadId.toString}") {
        ...
        res === """[{"id":"someId","userId":"someId","threadId":4534535,"recipientsHash":"dasfasfasfasd","time":"time","subject":"subject1","cc":"cc","bcc":"bcc","body":"emailBody"},{"id":"someId","userId":"someId","threadId":4534535,"recipientsHash":"dasfasfasfasd","time":"time1","subject":"subject1","cc":"cc","bcc":"bcc","body":"emailBody"}]"""
      }
    }
  }
}