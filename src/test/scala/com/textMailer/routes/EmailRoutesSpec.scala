...
class EmailRoutesSpec extends MutableScalatraSpec {
  ...
  "get /emails" should {
    "get emails for a topic" in {
      ...
      val email1 = Email("someEmId1", "someId", threadId, recipientsHash, 11l, "subject1", "sender1", "cc", "bcc", "emailBodyText", "emailBodyHtml")
      val email2 = Email("someEmId2", "someId", threadId, recipientsHash, 12l, "subject1", "sender2", "cc", "bcc", "emailBodyText", "emailBodyHtml")
