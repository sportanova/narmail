  ...
  " get /topics" should {
    "get topics for a conversation" in {
      ...
      get(s"/${user.id}/$recipientsHash") {
        ...
        res === """[{"userId":"someId","recipientsHash":"dasfasfasfasd","threadId":"4534535l","subject":"subject1","ts":1,"emailCount":2},{"userId":"someId","recipientsHash":"dasfasfasfasd","threadId":"54534535l","subject":"subject2","ts":2,"emailCount":2}]"""
      }
    }
  }
}